  ...
  <nav
    ...
    :class="{
      'z-index-3 w-100 shadow-none navbar-transparent position-absolute my-3':
        props.transparent,
      'my-3 blur border-radius-lg z-index-3 py-3 shadow py-2 start-0 end-0 mx-4 position-absolute mt-4':
        props.sticky,
  ...
  >
    ...
    >
      ...
      <RouterLink
        ...
        rel="tooltip"
        title="Designed and Coded by Peanut Genomics and Breeding Group"
	  ...
	  peanutGDB
		...
		<!-- 将搜索框的a链接改为了路由，可以连接到搜索页面，当前为about页面 -->
		<RouterLink
		:to="{ name: 'about' }"
      ...
      >
        <ul class="navbar-nav navbar-nav-hover ms-auto">
          ...
          <!-- <li class="nav-item dropdown dropdown-hover mx-2">
            <a
              href="https://www.github.com/huanglu2018"
